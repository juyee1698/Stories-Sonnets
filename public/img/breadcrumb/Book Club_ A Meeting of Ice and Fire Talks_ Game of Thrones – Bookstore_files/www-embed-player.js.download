...
function b(p){for(var t=g,r=0;64>r;r+=4)t[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=t[r-3]^t[r-8]^t[r-14]^t[r-16],t[r]=(p<<1|p>>>31)&4294967295;p=e[0];var A=e[1],D=e[2],T=e[3],vd=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ta=T^A&(D^T);var bc=1518500249}else Ta=A^D^T,bc=1859775393;else 60>r?(Ta=A&D|T&(A|D),bc=2400959708):(Ta=A^D^T,bc=3395469782);Ta=((p<<5|p>>>27)&4294967295)+Ta+vd+bc+t[r]&4294967295;vd=T;T=D;D=(A<<30|A>>>2)&4294967295;A=p;p=Ta}e[0]=e[0]+p&4294967295;e[1]=e[1]+
A&4294967295;e[2]=e[2]+D&4294967295;e[3]=e[3]+T&4294967295;e[4]=e[4]+vd&4294967295}
...
var td=!1,ud=new nd;function wd(){for(var a;a=ud.remove();){try{a.f.call(a.scope)}catch(b){kd(b)}jd(pd,a)}td=!1}
...
;new Ae;var Jh=tc||uc;function Kh(){var a=/WebKit\/([0-9]+)/.exec(Mb);return!!(a&&600<=parseInt(a[1],10))}
function Lh(){var a=/WebKit\/([0-9]+)/.exec(Mb);return!!(a&&602<=parseInt(a[1],10))}
function Mh(a){var b=Mb;return b?0<=b.toLowerCase().indexOf(a):!1}
;function Nh(a){if(!a)throw Error();throw a;}
...
X.all=function(a){return new X(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={L:0};f.L<a.length;f={L:f.L},++f.L)Ph(X.resolve(a[f.L]).then(function(g){return function(h){d[g.L]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
...
X.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:Oh,e=null!==b&&void 0!==b?b:Nh;return new X(function(f,g){"PENDING"===c.state.status?(c.f.push(function(){Qh(c,c,d,f,g)}),c.onRejected.push(function(){Rh(c,c,e,f,g)})):"FULFILLED"===c.state.status?Qh(c,c,d,f,g):"REJECTED"===c.state.status&&Rh(c,c,e,f,g)})};
function Ph(a,b){a.then(void 0,b)}
function Qh(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof X?Sh(a,b,f,d,e):d(f)}catch(g){e(g)}}
function Rh(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof X?Sh(a,b,f,d,e):d(f)}catch(g){e(g)}}
function Sh(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof X?Sh(a,b,f,d,e):d(f)},function(f){e(f)})}
;function Th(a,b,c){function d(){c(a.error);f()}
function e(){b(a.result);f()}
function f(){try{a.removeEventListener("success",e),a.removeEventListener("error",d)}catch(g){}}
a.addEventListener("success",e);a.addEventListener("error",d)}
function Uh(a){return new N(function(b,c){Th(a,b,c)})}
function Vh(a){return new X(function(b,c){Th(a,b,c)})}
;function Wh(a,b){return new X(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function Xh(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:fa(u(c)))}
v(Xh,Error);var Yh=[];function Zh(a,b){Yh.push({type:"EVENT",eventType:a,payload:b});10<Yh.length&&Yh.shift()}
;var $h={},ai=($h.AUTH_INVALID="No user identifier specified.",$h.EXPLICIT_ABORT="Transaction was explicitly aborted.",$h.IDB_NOT_SUPPORTED="IndexedDB is not supported.",$h.MISSING_OBJECT_STORE="Object store not created.",$h.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",$h.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",$h.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",$h);
function bi(a,b,c){b=void 0===b?{}:b;c=void 0===c?ai[a]:c;Xh.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;Object.setPrototypeOf(this,bi.prototype);Yh.push({type:"ERROR",payload:this});10<Yh.length&&Yh.shift()}
v(bi,Xh);function ci(a,b,c){bi.call(this,"UNKNOWN_ABORT",{objectStoreNames:a,dbName:b,mode:c});Object.setPrototypeOf(this,ci.prototype)}
v(ci,bi);function di(a,b){this.g=a;this.options=b;this.transactionCount=0;this.h=W();this.f=!1}
...
function ei(a,b,c,d){a.transactionCount++;c=a.g.transaction(b,void 0===c?"readonly":c);c=new gi(c);d=hi(c,d);ii(a,d,b.join());return d}
function ii(a,b,c){var d=W();Te(b.then(function(){ji(a,!0,c,W()-d)}),function(e){var f=W();
e instanceof ci&&(Zh("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:c,transactionDuration:f-d,transactionCount:a.transactionCount,dbDuration:f-a.h}),a.f=!0);ji(a,!1,c,f-d)})}
function ji(a,b,c,d){Zh("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.f,duration:d,isSuccessful:b})}
function ki(a){this.f=a}
n=ki.prototype;n.add=function(a,b){return Vh(this.f.add(a,b))};
n.clear=function(){return Vh(this.f.clear()).then(function(){})};
n.count=function(a){return Vh(this.f.count(a))};
function li(a,b){return mi(a,{query:b},function(c){return c["delete"]().then(function(){return c["continue"]()})}).then(function(){})}
n["delete"]=function(a){return a instanceof IDBKeyRange?li(this,a):Vh(this.f["delete"](a))};
n.get=function(a){return Vh(this.f.get(a))};
n.index=function(a){return new ni(this.f.index(a))};
n.getName=function(){return this.f.name};
function mi(a,b,c){a=a.f.openCursor(b.query,b.direction);return oi(a).then(function(d){return Wh(d,c)})}
function pi(a){for(var b=[],c=0;c<a.length;c++){var d=a.item(c);if(null===d)throw Error("Invariant: item in DOMStringList is null");b.push(d)}return b}
function gi(a){var b=this;this.f=a;this.g=new Map;this.aborted=!1;this.done=new N(function(c,d){b.f.addEventListener("complete",function(){c()});
b.f.addEventListener("error",function(e){e.currentTarget===e.target&&d(b.f.error)});
b.f.addEventListener("abort",function(){var e=b.f.error;if(e){var f=pi(b.f.objectStoreNames).join(),g=b.f.db.name,h=b.f.mode,k;"QuotaExceededError"===e.name?k=new bi("QUOTA_EXCEEDED",{objectStoreNames:f,dbName:g,mode:h}):"UnknownError"===e.name&&(k=new bi("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:f,dbName:g,mode:h}));k&&Zh("QUOTA_EXCEEDED",void 0);d(e)}else b.aborted||(e=new ci(pi(b.f.objectStoreNames).join(),b.f.db.name,b.f.mode),d(e))})})}
function hi(a,b){var c=new N(function(d,e){Ph(b(a).then(function(f){a.commit();d(f)}),e)});
return Re([c,a.done]).then(function(d){return u(d).next().value})}
gi.prototype.abort=function(){this.f.abort();this.aborted=!0;throw new bi("EXPLICIT_ABORT");};
gi.prototype.commit=function(){var a=this.f;a.commit&&!this.aborted&&a.commit()};
function fi(a,b){var c=a.f.objectStore(b),d=a.g.get(c);d||(d=new ki(c),a.g.set(c,d));return d}
function ni(a){this.f=a}
ni.prototype.count=function(a){return Vh(this.f.count(a))};
ni.prototype.get=function(a){return Vh(this.f.get(a))};
ni.prototype.getKey=function(a){return Vh(this.f.getKey(a))};
function qi(a,b){this.request=a;this.cursor=b}
function oi(a){return Vh(a).then(function(b){return null===b?null:new qi(a,b)})}
...
n["delete"]=function(){return Vh(this.cursor["delete"]()).then(function(){})};
n.getKey=function(){return this.cursor.key};
n.getValue=function(){return this.cursor.value};
n.update=function(a){return Vh(this.cursor.update(a))};function ri(a){function b(){k||(k=new di(c.result,{closed:h}));return k}
var c=self.indexedDB.open("yt-idb-test-do-not-use",void 0),d=a.blocked,e=a.blocking,f=a.Ib,g=a.upgrade,h=a.closed,k;g&&c.addEventListener("upgradeneeded",function(l){if(null===l.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===c.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");var m=b(),p=new gi(c.transaction);g(m,l.oldVersion,l.newVersion,p)});
d&&c.addEventListener("blocked",function(){d()});
return Uh(c).then(function(l){e&&l.addEventListener("versionchange",function(){e(b())});
f&&l.addEventListener("close",function(){f()});
return b()})}
function si(){var a=void 0===a?{}:a;return ri(a)}
;var ti,ui,vi=["getAll","getAllKeys","getKey","openKeyCursor"],wi=["getAll","getAllKeys","getKey","openKeyCursor"];function xi(){return cc(this,function b(){var c,d;return Ba(b,function(e){switch(e.g){case 1:if(Jh&&Kh()&&!Lh()&&!R("ytidb_allow_on_ios_safari_v8_and_v9")||gc)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(f){return e["return"](!1)}sa(e);return ra(e,Te(si(),function(){}));
...
b;a:{g=u(Pi);for(d=g.next();!d.done;d=g.next())if(Mh(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);d=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==d.length&&(1!==d.length||isNaN(Number(d[0]))?2!==d.length||isNaN(Number(d[0]))||isNaN(Number(d[1]))||(g.lineNumber=Number(d[0]),g.columnNumber=Number(d[1])):g.lineNumber=Number(d[0]));d=c.message;e=c.name;Li||(Li=new Ki);f=Li;a:{h=u(f.g);for(l=h.next();!l.done;l=h.next())if(l=
l.value,c.message&&c.message.match(l.f)){f=l.weight;break a}f=u(f.f);for(h=f.next();!h.done;h=f.next())if(h=h.value,h.Ga(c)){f=h.weight;break a}f=1}d={level:"ERROR_LEVEL_UNKNOWN",message:d,errorClassName:e,sampleWeight:f};"ERROR"===a?d.level="ERROR_LEVEL_ERROR":"WARNING"===a&&(d.level="ERROR_LEVEL_WARNNING");a={isObfuscated:!0,browserStackInfo:g};g={pageUrl:window.location.href};Q("FEXP_EXPERIMENTS")&&(g.experimentIds=Q("FEXP_EXPERIMENTS"));g.kvPairs=[];if(e=c.params)for(f=u(Object.keys(e)),h=f.next();!h.done;h=
f.next())h=h.value,g.kvPairs.push({key:"client."+h,value:String(e[h])});e=Q("SERVER_NAME",void 0);f=Q("SERVER_VERSION",void 0);e&&f&&(g.kvPairs.push({key:"server.name",value:e}),g.kvPairs.push({key:"server.version",value:f}));Ii("clientError",{errorMetadata:g,stackTrace:a,logMessage:d});Ng()}}if(!R("suppress_error_204_logging")){a=c.params||{};b={lb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},D:{url:Q("PAGE_NAME",window.location.href),
file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.D){c.stack&&(b.D.stack=c.stack);g=u(Object.keys(a));for(d=g.next();!d.done;d=g.next())d=d.value,b.D["client."+d]=a[d];if(a=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(g=u(Object.keys(a)),d=g.next();!d.done;d=g.next())d=d.value,b.D[d]=a[d];a=Q("SERVER_NAME",void 0);g=Q("SERVER_VERSION",void 0);a&&g&&(b.D["server.name"]=a,b.D["server.version"]=g)}th(Q("ECATCHER_REPORT_HOST","")+"/error_204",b)}Ni.add(c.message);
Oi++}}}
...
Ui.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Yf(b,function(){g.g=!1;window.botguard?Vi(g,c,d,f):(cg(b),Qi(new Xh("Unable to load Botguard","from "+b)))},e)):a&&(e=Kc(document,"SCRIPT"),e.textContent=a,e.nonce=Ga(),document.head.appendChild(e),document.head.removeChild(e),window.botguard?Vi(this,c,d,f):Qi(Error("Unable to load Botguard from JS")))};
...
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Xh("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Qi(c)),!0):!1}
...
vl.mver="MEASUREMENT_VERSION_",vl.pis="PLAYER_INITIALIZED_STATE_",vl.yt_pt="LATENCY_PLAYER_",vl.pa="LATENCY_ACTION_",vl.aq="TV_APP_QUALITY_",vl.yt_vst="VIDEO_STREAM_TYPE_",vl),xl="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
...
;function Al(a,b,c){if(null!==b)if(kl(c)[a]=b,yl(c)){var d=b;b=zl(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in tl){b=tl[a];0<=Ya(ul,b)&&(d=!!d);a in wl&&"string"===typeof d&&(d=wl[a]+d.toUpperCase().replace(/-/g,"_"));a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Qk({},e)}else 0<=Ya(xl,a)||Qi(new Xh("Unknown label logged with GEL CSI",
